...
import {ImageServices} from './imageService.js';

$(document).ready(function() {
  (async () => {
    let marsImageService = new ImageServices();
    const response = await marsImageService.getImageService();
    getMarsImages(response);
  })();
